...
let getAllDoctorsByPositionSpecialty = async (req, res) => {
  try {
    let response = await doctorService.getAllDoctorsByPositionSpecialty();
    return res.status(200).json(response);
  } catch (error) {
    console.log(error);
    return res.status(200).json({
...
let deleteDoctorInfor = async (req, res) => {
  try {
    let response = await doctorService.deleteDoctorInfor(req.body.id);
    return res.status(200).json(response);
  } catch (error) {
    console.log(error);
    return res.status(200).json({
...
let searchDoctors = async (req, res) => {
  try {
    let response = await doctorService.searchDoctors(req.query.data);
    return res.status(200).json(response);
  } catch (error) {
    console.log(error);
    return res.status(200).json({
